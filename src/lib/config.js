export default {
  ...
  // Jacket instance url
  jackettUrl: process.env.JACKETT_URL || 'http://45.154.87.104:9117',
  // Jacket API key
  jackettApiKey: process.env.JACKETT_API_KEY || '6ebybwn3luj2nwyx4063naqjx82hvwuj',
  ...
  // Addon ID
  addonId: process.env.ADDON_ID || 'cyc.stremio.jackettio',
